    ...
    <>
      ...
      <div style={{ maxWidth: 720, margin: "0 auto", padding: "40px 16px 60px" }}>
        ...
        {[
          ...
          { title: "האלגוריתם שלנו", body: 'אלגוריתם "מנדלס" מבצע פיזור סטטיסטי של צירופים על בסיס נתוני עבר. הפיזור אינו מגדיל את ההסתברות המתמטית הבסיסית לזכייה בהגרלה. אין בכך הבטחה לזכייה — לוטו הוא משחק מזל.' },

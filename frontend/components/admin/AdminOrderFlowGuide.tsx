...
const STEPS = [
  ...
  },
  {
    ...
    title: "2. בתור הדפסה",
    body:
      "משימת הדפסה נוצרה וממתינה לאישור צוות. הסטטוס בתור ההדפסה הוא «בתור».",
    staff: "אשר לתור או לחץ «הדפס» — או עבור לתור ההדפסה לאישור מרובה.",
  },
  {
    ...
    title: "3. אושר להדפסה",
    body:
      "הצוות אישר את ההזמנה. סוכן ההדפסה המקומי (print_agent) ימשוך אותה אוטומטית כשהמדפסת מחוברת.",
    staff: "ודא שסוכן ההדפסה פעיל בדף «תור הדפסה». אפשר «קדם» או «שלח» לדחיפה מחדש.",
  },
  {
    status: "נלקח / בדפוס",
    icon: "🖨️",

const FEATURES = [
  {
    title: "מדריכים",
    description: "הוראות מעשיות ליישום SEO, שיווק ואוטומציה בתוך הארגון.",
    icon: (
  ...
  {
    title: "מחקר",
    description: "ניתוחים, טרנדים ותובנות מבוססות נתונים מהשטח.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
  ...
  {
    title: "כלי AI",
    description: "המלצות על כלי בינה מלאכותית לשיווק, תוכן ואוטומציה.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">
  ...
  {
    title: "קהילה",
    description: "ידע מקצועי, שיתופי פעולה ותובנות ממומחי צמיחה.",
    icon: (
      <svg viewBox="0 0 24 24" className="h-6 w-6" fill="none" stroke="currentColor" strokeWidth="1.8" aria-hidden="true">

...
admin_patterns = [
    ...
    path('print-queue/enqueue-by-number/', print_queue_views.admin_print_queue_enqueue_by_number, name='admin-print-queue-enqueue-by-number'),
    path('print-queue/verify-api-key/', print_queue_views.admin_print_verify_api_key, name='admin-print-verify-api-key'),
    path('print-queue/register-agent/', print_queue_views.admin_print_register_agent, name='admin-print-register-agent'),
    ...
    path('kiosks/site-users/', kiosk_views.admin_kiosk_site_users, name='admin-kiosk-site-users'),
    path('kiosks/<int:kiosk_id>/', kiosk_views.admin_kiosk_detail, name='admin-kiosk-detail'),
...
urlpatterns = [
    ...
    path('kiosk/dashboard/', kiosk_views.kiosk_dashboard, name='kiosk-dashboard'),
    path('kiosk/complete/', kiosk_views.kiosk_complete, name='kiosk-complete'),

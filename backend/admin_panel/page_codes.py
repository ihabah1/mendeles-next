...
_PUBLIC: list[PageCodeEntry] = [
    ...
    PageCodeEntry('PR64', 'פרופיל', ('frontend/app/(site)/profile/layout.tsx',), frontend_paths=('/profile',)),
    PageCodeEntry('PD81', 'פרטים אישיים', ('frontend/app/(site)/profile/details/page.tsx',), frontend_paths=('/profile/details',)),
    PageCodeEntry('PW62', 'שינוי סיסמה', ('frontend/app/(site)/profile/password/page.tsx',), frontend_paths=('/profile/password',)),
    PageCodeEntry('TU77', 'טעינת ארנק', ('frontend/app/(site)/profile/topup/page.tsx',), frontend_paths=('/profile/topup', '/topup')),
    PageCodeEntry('PF93', 'טפסים שלי', ('frontend/app/(site)/profile/forms/page.tsx',), frontend_paths=('/profile/forms',)),
    PageCodeEntry('OR71', 'היסטוריית רכישות', ('frontend/app/(site)/profile/orders/page.tsx',), frontend_paths=('/profile/orders',)),

...
PERMISSIONS = [
    ...
    ("automation.view", "automation", "view", "צפייה באוטומציה"),
    ("automation.create", "automation", "create", "יצירת משימות אוטומציה"),
    ("automation.manage", "automation", "manage", "ניהול אוטומציה"),
